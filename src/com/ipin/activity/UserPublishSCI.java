...
public class UserPublishSCI extends Activity implements OnItemClickListener, PostActivityConst{
	private static final String TAG = "UserPublishSCI";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.userpublishsci);
	...
	public void onItemClick(AdapterView<?> adapterView, View view,
		...
		case ITEM_SETTING:
			...
			break;
		case ITEM_BACKLOGIN:
			((IpinApplication)UserPublishSCI.this.getApplication()).logoutUser();
			break;
		case ITEM_EXIT:
			ApplicationExit.exit((IpinApplication)UserPublishSCI.this.getApplication());
			return;
		}
